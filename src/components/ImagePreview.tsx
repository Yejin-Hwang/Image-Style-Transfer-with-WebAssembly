...
export function ImagePreview({ 
  ...
  if (!previewUrl) {
    return (
      <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center text-black">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border rounded-lg overflow-hidden bg-white">
        <div className="p-4 border-b bg-gray-50">
          <div className="flex justify-between items-center">
            <h3 className="font-medium text-black">Original Image</h3>
            <button
              onClick={onClear}
      ...
      <div className="border rounded-lg bg-white p-4">
        <h4 className="font-medium text-black mb-3">Processing Status</h4>
        
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <span className="text-black">Image loaded:</span>
            <span className="font-medium text-green-600">✓ Ready</span>
          </div>
          
          <div className="flex justify-between items-center">
            <span className="text-black">Preprocessed:</span>
            {preprocessedImage ? (
          ...
          {preprocessedImage && (
            <div className="text-sm text-black mt-2 p-2 bg-gray-50 rounded">
